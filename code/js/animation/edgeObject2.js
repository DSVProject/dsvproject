...
/**
  ...
  */
var EdgeObject2 = function(id, idObjectA, idObjectB, edgeClass, edgeType){
  var propObj = {
    "id": null,
  ...
  function initPropObj(){
    ...
    propObj.edge.idObjectA = idObjectA;
    propObj.edge.idObjectB = idObjectB;
